    ...
    <div className="bg-black min-h-screen w-full px-4 sm:px-8 lg:px-20 xl:px-40 py-12 sm:py-16 lg:py-20 flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-white font-bold leading-tight animate-fade-in-1000">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mt-6 sm:mt-8 mb-8 sm:mb-12">
          <div className="group">
            <p className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-center text-white font-semibold bg-gradient-to-r from-[#ff00d6] to-[#e600c4] rounded-full text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-left-500 cursor-pointer">
              ❌ Anúncios que não geram retorno
            </p>
          </div>
          <div className="group">
            <p className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-center text-white font-semibold bg-gradient-to-r from-[#5facfc] to-[#2881b8] rounded-full text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-left-1000 cursor-pointer">
              ❌ Sites que ninguém acessa
            </p>
          </div>
          <div className="group">
            <p className="px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-center text-white font-semibold bg-gradient-to-r from-[#6138ff] to-[#4c2db8] rounded-full text-sm sm:text-base transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fade-in-left-1500 cursor-pointer">
        ...
        <div className="relative">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-white font-bold uppercase leading-tight animate-fade-in-right-1000 pl-8">
